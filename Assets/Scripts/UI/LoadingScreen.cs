...
public class LoadingScreen : MonoBehaviour
{
    ...
    internal IEnumerator CallLoadingScreen(Scenes sceneToLoad, GameState stateAfterLoad)
    {
        ...
        AsyncOperation operation = SceneHandler.instance.UnloadScene(SceneHandler.instance.Scene);
    ...
    internal IEnumerator CallLoadingScreen(Scenes sceneToLoad, GameState stateAfterLoad, float duration, OnFinishFade onFinishFade = null)
    {
